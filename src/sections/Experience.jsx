...
const experience = [
  {
    id: 1,
    title: 'AI & ML with Data Science Intern',
    company: 'YBI Foundation',
    period: 'Currently Pursuing',
    description: [
      'Applied Python and ML libraries for data preprocessing, model building, and real-time workflows',
      'Communicated technical findings to team leads and translated insights for non-technical audiences',
      'Developed practical AI/ML solutions aligned with data-driven decision making'
    ],
    icon: Briefcase
  },
  {
    ...
    description: [
      ...
      'Gained full-stack exposure across front-end and back-end development',
      'Collaborated remotely with cross-functional teams to deliver polished interfaces'
    ],
    icon: Briefcase
  },
  {
    ...
    company: 'Codegnan',
    period: 'Jul 2024 | Remote',
    description: [
      'Developed Python scripts for backend logic, data processing, and automation',
      'Documented workflows and supported engineering handoffs',
      'Worked on scalable backend solutions for real-world applications'
    ],
    icon: Briefcase
  }
];
