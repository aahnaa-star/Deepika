...
import { Mail, Phone, Github, Linkedin, MapPin, ArrowUpRight, Send, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-4 mb-12">
              <motion.a
                href="mailto:ndeepika121828@gmail.com"
              ...
              <motion.div
                ...
                data-cursor="pointer"
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--accent-secondary)]/20 to-[var(--accent-pink)]/20 flex items-center justify-center">
                  <Phone className="w-5 h-5 text-[var(--accent-secondary)]" />
                </div>
                <div>
                  <p className="text-sm text-[var(--text-muted)]">Phone</p>
                  <p className="text-white">+91 7093691589</p>
                </div>
              </motion.div>
            ...
            <div className="flex gap-4">
              ...
              <motion.a
                href="https://linkedin.com/in/nadakuditi-deepika"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 rounded-full glass hover:bg-white/5 transition-colors text-[var(--text-secondary)] hover:text-white"
                whileHover={{ y: -2 }}
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="glass rounded-3xl p-8 space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Nadakuditi Deepika"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--accent-pink)] transition-colors"
                  placeholder="ndeepika121828@gmail.com"
                />
              </div>
