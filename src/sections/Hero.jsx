          ...
          <div className="space-y-8">
            ...
            >
              ...
              <span className="text-sm font-medium text-[var(--text-secondary)] tracking-widest uppercase">
                01 — B.Tech CSE (AI/ML) | Full Stack Developer
              </span>
            </motion.div>
            ...
            >
              <AnimatedName text="NADAKUDITI" isInView={isInView} />
              <br />
              <motion.span 
            ...
            >
              <span className="text-white font-semibold">B.Tech CSE (AI/ML) student</span> and 
              <span className="text-[var(--accent-secondary)]"> Full Stack Developer</span> building 
              <span className="text-[var(--accent-primary)]"> intelligent, data-driven applications</span>. 
              <br className="hidden md:block" />
              <span className="text-sm md:text-base opacity-80">
                Python, Django, Flask, React, and ML-powered solutions for real problems.
              </span>
            </motion.p>
