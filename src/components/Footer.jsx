        ...
        <div className="glass p-6 rounded-2xl">
          <div className="flex flex-col items-center justify-between gap-3 md:flex-row">
            ...
            <div className="flex flex-col items-center gap-0.5 md:items-start">
              <span className="text-base font-semibold text-white">Nadakuditi Deepika</span>
              <p className="text-[var(--accent-primary)]/80 text-xs">Built with passion, powered by Deepika</p>
              <p className="text-xs text-gray-400/80 text-center md:text-left">
                © {currentYear} Nadakuditi Deepika. Crafting intelligent experiences.
              </p>
            </div>
